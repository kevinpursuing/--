...
<div align="center" style="color:#FF3300;margin:5pt;font-family:Verdana"> TP <sup style='color:gray;font-size:9pt'><?php echo THINK_VERSION;?></sup><span style='color:silver'> MCBN 专用版</span>
</div>
</body>
</html>