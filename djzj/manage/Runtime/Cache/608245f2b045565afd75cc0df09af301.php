        ...
        <div class="wrapper">
			...
			<div class="row">
                ...
                <header class="panel-heading">
					<?php if($_GET['fid']==2){ ?>
						<span style="color:#999;"><?php echo (date('Y-m-d',$game["ktime"])); ?></span>
						<span style="color:#000;"><?php echo ($game["name"]); ?></span>
						<span style="color:#3366CC;"><?php echo ($team1["name"]); ?></span>
						<span style="color:#CC3333;">VS</span>
						<span style="color:#3366CC;"><?php echo ($team2["name"]); ?></span>
					<?php }else{ ?>
						<?php echo ($game["name"]); ?>
					<?php } ?>
                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="">
							...
							<?php } ?>
							<td><?php echo (date('Y-m-d H:i',$l["starttime"])); ?></td>
							<td><?php echo (date('Y-m-d H:i',$l["endtime"])); ?></td>
							<td><?php echo ($l["cname"]); ?></td>
							<td><?php echo ($l["cstatename"]); ?></td>
							<td><?php echo ($l["check1"]); ?><br /><?php echo ($l["cren1"]); ?><br /><?php echo ($l["cjinbi1"]); ?></td>
							<td><?php echo ($l["check2"]); ?><br /><?php echo ($l["cren2"]); ?><br /><?php echo ($l["cjinbi2"]); ?></td>
							<td>
								<!--<a href="#bianjibox<?php echo ($l["id"]); ?>">重新结算</a>
								|
								<a href="#bianjibox<?php echo ($l["id"]); ?>">流盘</a>
								<br />-->
								<a class="tan_edit" data-toggle="modal" href="#bianjibox<?php echo ($l["id"]); ?>">编辑</a>
								|
								<?php if($l['state']==1){ ?>
									<a href="javascript:;" onclick="del_admin(<?php echo ($l["id"]); ?>,'game_ju',this,'id')">删除</a>
								<?php }else{ ?>
									<a href="javascript:;" onclick="hui_admin(<?php echo ($l["id"]); ?>,'game_ju',this,'id')">恢复</a>
									|
									<a href="javascript:;" class="cddel_admin_btn" onclick="cddel_admin(<?php echo ($l["id"]); ?>,'game_ju',this,'id')">彻底删除</a>
								<?php } ?>
							</td>
						</tr>
						<!--编辑框 start-->
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body ">
										<form action="<?php echo U('Games/game_ju_edit');?>" method="post">
											...
											<?php if($_GET['fid']==2){ ?>
												...
												<div class="form-group">
													<label>开赛时间</label>
													<input type="text" name="ktime" value="<?php echo (date('Y-m-d H:i',$l["ktime"])); ?>" readonly class="form_datetime form-control">
												</div>
											<?php }else{ ?>
											...
											<div class="form-group">
												<label>竞猜项目</label>
												<input name="cname" value="<?php echo ($l["cname"]); ?>" class="form-control">
											</div>
											<div class="form-group">
												<label>竞猜选项A</label>
												<input name="check1" value="<?php echo ($l["check1"]); ?>" class="form-control">
											</div>
											<div class="form-group">
												<label>竞猜选项B</label>
												<input name="check2" value="<?php echo ($l["check2"]); ?>" class="form-control">
											</div>
											<div class="form-group">
												<label>竞猜状态</label>
												<select name="cstate" class="form-control">
													<?php if(is_array($cstate)): $i = 0; $__LIST__ = $cstate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($c["id"]); ?>"  <?php if($c['id']==$l['cstate']){ ?>selected="selected"<?php } ?>><?php echo ($c["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
											<div class="form-group">
												<label>盘出现时间</label>
												<input type="text" name="starttime" value="<?php echo (date('Y-m-d H:i',$l["starttime"])); ?>" readonly class="form_datetime form-control">
											</div>
											<div class="form-group">
												<label>盘消失时间</label>
												<input type="text" name="endtime" value="<?php echo (date('Y-m-d H:i',$l["endtime"])); ?>" readonly class="form_datetime form-control">
											</div>
											<div class="form-group">
												<label>竞猜选项A人数</label>
												<input name="cren1" value="<?php echo ($l["cren1"]); ?>" class="form-control">
											</div>
											<div class="form-group">
												<label>竞猜选项A金币</label>
												<input name="cjinbi1" value="<?php echo ($l["cjinbi1"]); ?>" class="form-control">
											</div>
											<div class="form-group">
												<label>竞猜选项B人数</label>
												<input name="cren2" value="<?php echo ($l["cren2"]); ?>" class="form-control">
											</div>
											<div class="form-group">
												<label>竞猜选项B金币</label>
												<input name="cjinbi2" value="<?php echo ($l["cjinbi2"]); ?>" class="form-control">
											</div>
											<div class="form-group">
												<label>排序</label>
					...
					<div class="modal-body">
						<form action="<?php echo U('Games/game_ju_edit');?>" method="post">
							...
							<div class="form-group">
								<label>竞猜状态</label>
								<select name="cstate" class="form-control">
									<?php if(is_array($cstate)): $i = 0; $__LIST__ = $cstate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($c["id"]); ?>" ><?php echo ($c["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
							<div class="form-group">
								<label>盘出现时间</label>
