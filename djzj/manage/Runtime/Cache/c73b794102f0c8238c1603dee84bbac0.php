        ...
        <div class="wrapper">
			...
			<div class="row">
                ...
                <header class="panel-heading">
                    <a href="<?php echo U('Games/games',array(gid=>$gid,fid=>1));?>" style="color:#65CEA7;">主播列表</a>
                    <a href="<?php echo U('Games/games',array(gid=>$gid,fid=>2));?>" style="color:#666;">比赛列表</a>
                ...
                <div class="clearfix">
                    <div class="btn-group">
						...
						<a href="<?php echo U('Games/games_changetime');?>" target="_blank" >
							变时间
                        </a>
                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="">
							...
							<td><img src="<?php echo ($l["ptlogo"]); ?>" height="40" /></td>
							<td>
										...
										<form action="<?php echo U('Games/games_edit');?>" method="post">
											...
											<div class="form-group">
												...
												<select name="ptid" class="form-control">
													<?php if(is_array($pingtai)): $i = 0; $__LIST__ = $pingtai;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><option value="<?php echo ($p["id"]); ?>"  <?php if($p['id']==$l['ptid']){ ?>selected="selected"<?php } ?>><?php echo ($p["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
											<div class="form-group">
												<label>排序</label>
					...
					<div class="modal-body">
						<form action="<?php echo U('Games/games_edit');?>" method="post">
							...
							<div class="form-group">
								<label>平台LOGO</label>
								<select name="ptid" class="form-control">
									<?php if(is_array($pingtai)): $i = 0; $__LIST__ = $pingtai;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><option value="<?php echo ($p["id"]); ?>"><?php echo ($p["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
							<div class="form-group">
								<label>排序</label>
