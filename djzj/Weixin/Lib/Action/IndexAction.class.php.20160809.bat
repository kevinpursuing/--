...
//		exit;
		...
		switch($type) {
			case Wechat::MSGTYPE_TEXT:
				$weObj->text("小菠已经收到您的消息～\n欢迎加入交流qq群获取最新动态～\n以及随时私聊小菠～[飞吻]\n群号\nLOL:  528279088\nDOTA: 295416108\n\n\n\n<a href='http://wap.esports666.com/index.php?a=roll&m=Active'>VPGAME的密码是：djzj0809 卡尔的秘宝活动正在展开！每天送至宝，免费参加！ 点击【活动】>【dota2】确定不点我一下吗？[可怜]</a>\n\n\n\n<a href='http://wap.esports666.com/index.php?a=indexs&m=active'>参与大转盘抽奖：点击【活动】>【LOL】 就可参与大转盘抽奖啦，众多皮肤点券等你来拿[勾引]</a>")->reply();
				exit;
				break;
				...
				array(
					...
					'sub_button'=>array(
						array(
							'type'=>'view',
							'name'=>'DOTA2',
							'url'=>'http://wap.esports666.com/index.php?a=roll&m=active'
						),
						array(
							'type'=>'view',
							'name'=>'LOL',
							'url'=>'http://wap.esports666.com/index.php?a=indexs&m=active'
						),
					),
				),
				array(
