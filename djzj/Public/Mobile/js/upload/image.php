...
class image {
        ...
        public function thumb($filename,$new_w,$new_h,$cut=0,$big=0){
        // 获取原图信息   
    ...
    // water(保存地址,水印图片,水印位置,透明度)
        public function water($filename,$water,$pos=9,$pct=100){
                // 加载水印图片
                ...
                //$water_w = (int)(0.2*$old_w);
				//$bilizhi=$water_w/$water_wj;
				//$water_h = (int)($bilizhi*$water_hj);

				//$waterimg = imagecreatetruecolor($water_w, $water_h); 
				//$waterimg = imagecreate($water_w, $water_h); 
				//$wt_background_color = imagecolorallocate($waterimg, 0,0,0); 
				//imagecolortransparent($waterimg,$wt_background_color);
//				$wt_white = imagecolorallocate($waterimg, 255, 255, 255);
//				imagechar($waterimg,2,0,0,"CHINA SPOSA.com",$wt_white);
				//imagecopyresized($waterimg,$waterimgj,0,0,0,0,$water_w,$water_h,$water_wj,$water_hj);
