...
<!--主体-->
<div class="wrap margin-top58 about rules-ab">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><dl>
			<dd><?php echo ($l["detail"]); ?></dd>
			<dt>金币<?php echo ($l["changeAmount"]); ?></dt><div class="clearfix"></div>
			<div class="row">
				<div class="col-md-9 rules-list-l"><?php echo (date("Y-m-d H:i:s",$l["ctime"])); ?></div>
				<div class="col-md-3 rules-list-r">金币余额 <?php echo ($l["amount"]); ?></div>
			</div>
