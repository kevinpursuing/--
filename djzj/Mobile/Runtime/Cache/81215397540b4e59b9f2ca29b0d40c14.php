...
<?php if((ACTION_NAME) == "myqr"): else: ?>
    ...
    <link rel="stylesheet" type="text/css" href="Public/Mobile/css/teamsindex.css?201610141617">
    <div class="gamenav">
    <ul>
        <li>
    ...
    <div class="teamsindex">
        ...
        <div class="team-h" style="display: none;">
            <ul>
                ...
                <li><a <?php if((ACTION_NAME) == "sologames"): ?>class="active"<?php endif; ?> href="<?php echo U('Index/soloindex');?>">我的SOLO</a></li>
            </ul>
        </div>
        ...
        <div class="team-intro">
            <!-- 帮助以及内容修改 -->
            <div class="icon">
                <?php if($team['duid']==$_SESSION['user_id']){ ?>
                    <a href="<?php echo U('Index/lolteams');?>"><div class=modify><img src="Public/Mobile/new/images/games/xiugai.png"></div></a>
                <?php } ?>
            ...
            <div class="index-intro">
                ...
                <p><?php echo ($team["duxuexiao"]); ?></p>
                <p>比赛项目：<?php echo ($team["xiangmuname"]); ?></p>
                <p>队长手机号：<?php echo ($team["duphone"]); ?></p>
                <p><a href="<?php echo U('Index/cfunding',array(tid=>$team[id]));?>">众筹奖金：<?php echo ($team["jiangjin"]); ?></a></p>
            </div>
            <div class="ticf-btn">
                <a href="<?php echo U('Index/cfunding',array(tid=>$team[id]));?>"><img src="Public/Mobile/new/images/games/dianwozhongchou.png"></a>
            </div>
        </div>
        <p class="ht">参赛成员</p>
        <div class="team-member">
            <div class="team-member-content">
                <div class="member">
                    <a href="<?php echo U('Index/perinfo',array(uid=>$team[duid]));?>">
                        <div class="leader-icon"><img src="./Public/Mobile/new/images/games/duizhang.png"></div>
                        <div class="member-logo">
                            <img src="<?php echo ($team["duheader"]); ?>">
                        </div>
                        <p class="white"><?php echo ($team["duname"]); ?></p>
                        <p class="white"><?php echo ($team["dubanji"]); ?></p>
                        <p class="light-blue"><?php echo ($team["duweizhi"]); ?></p>
                    </a>
                </div>
                <?php if(is_array($team_users)): $i = 0; $__LIST__ = $team_users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><div class="member">
                        <a href="<?php echo U('Index/perinfo',array(uid=>$u[uid]));?>">
                            <div class="member-logo">
                                <img src="<?php echo ($u["header"]); ?>">
                            </div>
                            <p class="white"><?php echo ($u["name"]); ?></p>
                            <p class="white"><?php echo ($u["banji"]); ?></p>
                            <p class="light-blue"><?php echo ($u["weizhiname"]); ?></p>
                        </a>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                <?php if(($yiyouzd) == "0"): ?><div class="join">
                        <div class="join-btn"><img src="./Public/Mobile/new/images/games/jiahao.png"></div>
                        <p class="light-blue">申请加入</p>
                    </div><?php endif; ?>
        ...
        <p class="ht">参赛纪录</p>
        <div class="team-record" style="height: auto;margin-bottom:70px;">
            <?php if(is_array($jilu)): $i = 0; $__LIST__ = $jilu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$j): $mod = ($i % 2 );++$i;?><div class="t-bet1">
                    <div class="t-logo1">
                        <img src="<?php echo ($j["team1info"]["logo"]); ?>" alt="<?php echo ($j["team1info"]["name"]); ?>">
                        <div class="t-tname">
                            <?php echo ($j["team1info"]["name"]); ?>
                        </div>
                    </div>
                    <div class="t-logomid">
                    ...
                    <div class="t-logo2">
                        <img src="<?php echo ($j["team2info"]["logo"]); ?>" alt="<?php echo ($j["team2info"]["name"]); ?>">
                        <div class="t-tname">
                            <?php echo ($j["team2info"]["name"]); ?>
                        </div>
                    </div>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="screen1" style="display: none;"></div>
            <div class="t-boss">
                ...
                <div>
                    ...
                    <input type="hidden" id="geren_teamid" value="<?php echo ($team["id"]); ?>">
