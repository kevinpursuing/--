...
<!--主体-->
<div class="wrap">
	<?php if(is_array($user_recoms)): $i = 0; $__LIST__ = $user_recoms;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><div class="row Comrades">
			...
			<div class="col-md-9 ">
				<dl>
					<dt><?php echo ($u["name"]); ?></dt>
					<div class="clearfix"></div>
					<dd><label>招募时间：</label><?php echo (date('Y-m-d H:i:s',$u["ctime"])); ?></dd>
					<dd><label>已奖励：</label><?php echo ($u["recomgolds"]); ?>金币</dd>
				</dl> 
			</div>
		</div><?php endforeach; endif; else: echo "" ;endif; ?>
	<?php if(empty($user_recoms)): ?><p style=" margin:100px auto; text-align:center; font-size:16px;">你还没有战友，赶快邀请你的小伙伴吧！</p><?php endif; ?>
</div>
<style type="text/css">
.Comrades dl dd{width:100% !important;}
</style>
<div class="footerbox">
    <ul>
