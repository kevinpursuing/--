...
// });
    ...
    <div class="sub-h sub-h1" style="display: none;">
        <?php if(is_array($bs_xiangmu)): $i = 0; $__LIST__ = $bs_xiangmu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/teamlist',array(mid=>$l[id],xid=>$_GET[xid]));?>"><div class="lol-event"><?php echo ($l["name"]); ?></div></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <div class="sub-h sub-h2" style="display: none;">
        <?php if(is_array($bs_xuexiao)): $i = 0; $__LIST__ = $bs_xuexiao;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/teamlist',array(xid=>$l[id],mid=>$_GET[mid]));?>"><div class="lol-event"><?php echo ($l["name"]); ?></div></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <script type="text/javascript">
    var cl = 0;
    ...
    <div class="team-list-content" style="height: auto;margin-bottom:70px;">
        <?php if(is_array($teams)): $i = 0; $__LIST__ = $teams;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><div class="t-list">
                <!-- 战队logo -->
                <a href="<?php echo U('Index/teamsindex',array(id=>$l[id]));?>">
                    <div class="t-l-logo">
                        <img src="<?php echo ($l["logo"]); ?>">
                    </div>
                    <div class="t-l-content">
                        <p class="teamname"><?php echo ($l["name"]); ?></p>
                        <p><span class="dark-gray"><?php echo ($l["xiangmuname"]); ?></span>/<span class="dark-gray"><?php echo ($l["rennum"]); ?>人</span></p>
                        <p><span class="light-blue">众筹奖金：</span><span class="light-blue"><?php echo ($l["jiangjin"]); ?></span></p>
                    </div>
