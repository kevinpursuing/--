...
<!--主体-->
<div class="wrap margin-top58 about rules-ab tabcont">

	<ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">主播竞猜</a></li>
		<li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">赛事竞猜</a></li>
		<li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">英雄猜</a></li>
		<li role="presentation"><a href="#dld" aria-controls="dld" role="tab" data-toggle="tab">大乱斗</a></li>
	</ul>
    
	<!-- Tab panes -->
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="home">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><dl <?php if(!empty($l["jgolds"])): ?>class="bg-quiz"<?php endif; ?>>
					<dd><?php echo (date("Y-m-d H:i:s",$l["ctime"])); ?></dd>
					<dt><?php echo ($l["gamename"]); ?></dt><div class="clearfix"></div>
					<div class="row">
						<div class="col-md"><?php echo ($l["cname"]); ?></div>
						<div class="col-md">竞猜：<?php echo ($l["checkname"]); ?>（<?php echo ($l["peilv"]); ?>）</div>
						<div class="col-md">结果：<?php echo ($l["jieguo"]); ?></div>
						<div class="col-md">
							投注：<?php echo ($l["changeAmount"]); ?>金币
							<?php if(($l["jieguoid"]) == "1"): ?><span class="Gold"><?php echo ($l["jgolds"]); ?></span><?php endif; ?>
							<?php if(($l["jieguoid"]) == "2"): ?><span class="sub-Gold"><?php echo ($l["jgolds"]); ?></span><?php endif; ?>
						</div>
					</div>
        ...
        <div role="tabpanel" class="tab-pane" id="profile">
			...
			<?php if(is_array($list_bs)): $i = 0; $__LIST__ = $list_bs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><dl <?php if(!empty($l["jgolds"])): ?>class="bg-quiz"<?php endif; ?>>
					<dd><?php echo (date("Y-m-d H:i:s",$l["ctime"])); ?></dd>
					<dt><?php echo ($l["gamename"]); echo ($l["name"]); ?></dt><div class="clearfix"></div>
					<div class="row">
						<div class="col-md"><?php echo ($l["cname"]); ?></div>
						<div class="col-md">竞猜：<?php echo ($l["checkname"]); ?>（<?php echo ($l["peilv"]); ?>）</div>
						<div class="col-md">结果：<?php echo ($l["jieguo"]); ?></div>
		...
		<div role="tabpanel" class="tab-pane" id="messages">
			...
			<?php if(is_array($list_yxc)): $i = 0; $__LIST__ = $list_yxc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><dl <?php if(!empty($l["jgolds"])): ?>class="bg-quiz"<?php endif; ?>>
				<dd><?php echo (date("Y-m-d H:i:s",$l["ctime"])); ?></dd>
				<dt><?php echo ($l["gamename"]); ?> <?php echo ($l["herodayqi"]); ?>期</dt><div class="clearfix"></div>
				<div class="row">
					<div class="col-md">竞猜：<?php echo ($l["checkname"]); ?>（<?php echo ($l["peilv"]); ?>）</div>
					<div class="col-md">结果：<?php echo ($l["jieguo"]); ?></div>
					<div class="col-md">
		...
		<div role="tabpanel" class="tab-pane" id="dld">

			<?php if(is_array($list_dld)): $i = 0; $__LIST__ = $list_dld;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><dl <?php if(!empty($d["jgolds"])): ?>class="bg-quiz"<?php endif; ?>>
				<dd><?php echo (date("Y-m-d H:i:s",$d["ctime"])); ?></dd>
				<dt><?php echo ($d["gamename"]); ?>大乱斗 <?php echo ($d["dld"]["qi"]); ?>期</dt><div class="clearfix"></div>
				<div class="row">
					<div class="col-md">结果：<?php echo ($d["jieguo"]); ?></div>
					<div class="col-md">
						投注：<?php echo ($d["changeAmount"]); ?>金币
						<?php if(($d["jieguoid"]) == "1"): ?><span class="Gold"><?php echo ($d["jgolds"]); ?></span><?php endif; ?>
						<?php if(($d["jieguoid"]) == "2"): ?><span class="sub-Gold"><?php echo ($d["jgolds"]); ?></span><?php endif; ?>
					</div>
				</div>
				</dl><?php endforeach; endif; else: echo "" ;endif; ?>
