...
<div class="wrap">
	...
	<div class="nav">
		<div class="jingcai_nav">
			<a href="<?php echo U('Index/index');?>">
				<img class="jingcai_nav_pic" src="__PUBLIC__/new/images/zixun/jincai.png" alt="">
			</a>
		</div>
		<div class="zixun_nav" >
			<a href="<?php echo U('News/news');?>">
				<img class="zixun_nav_pic" src="__PUBLIC__/new/images/zixun/zixun-active.png" alt="">
			</a>
		</div>
	</div>
    ...
    <div class="zixun" >
    	<a href="/index.php?a=readArticles&m=news&id=<?php echo ($zixun["content"]["0"]["id"]); ?>">
    		    	<div class="banner" >
						<img src="<?php echo ($zixun["content"]["0"]["header"]); ?>" class="banner_img" />
    		    		<div class="banner_detail">
    		    			<p id="banner_title">
    		    				<?php echo ($zixun["content"]["0"]["title"]); ?>
    		    			</p>
							<div class="banner_info">
								<div class="banner_pubtime">
									<div class="pubtime_detail">
										<p id="banner_pubtime">
											<?php echo ($zixun["content"]["0"]["ctime"]); ?>
										</p>
									</div>
									<div class="pubtime_clock">
										<img class="pubtime_clock_pic" src="__PUBLIC__/new/images/zixun/banner-clock.png" alt="">
									</div>
								</div>
								<!--<div class="banner_readtimes">
									<div class="readtimes_eye">
										<img class="readtimes_eye_pic" src="__PUBLIC__/new/images/zixun/banner-eye.png" alt="">
									</div>
									<div class="readtimes_detail">
										<p id="banner_readtimes">
											<?php echo ($zixun["content"]["0"]["readtimes"]); ?>
										</p>
									</div>
								</div>-->
							</div>
		...
		<?php if(is_array($zixun["content"])): $i = 0; $__LIST__ = array_slice($zixun["content"],1,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href='/index.php?a=readArticles&m=news&id=<?php echo ($zixun["content"]["$i"]["id"]); ?>'>
						<div class="content_item">
							<div class="item_pic">							
									<img src="<?php echo ($vo["header"]); ?>" alt="">
							</div>
							<div class="item_intro">
								<div class="item_intro_title">
				    				<?php echo ($vo["title"]); ?>					
								</div>
								<div class="item_info">
					    			<div class="item_pubtime">
						    			<div class="item_pubtime_clock">
						    				<img class="pubtime_clock_pic" src="__PUBLIC__/new/images/zixun/info-clock.png" alt="">
						    			</div>
						    			<div class="item_pubtime_detail">
						    				<p>
						    					<?php echo ($vo["ctime"]); ?>
						    				</p>
						    			</div>
					    			</div>
						    		<!--<div class="item_readtimes">
						    			<div class="item_readtimes_detail">
						    				<p>
							    				<?php echo ($vo["readtimes"]); ?>
						    				</p>
						    			</div>
						    			<div class="item_readtimes_eye">
						    				<img class="item_readtimes_eye_pic" src="__PUBLIC__/new/images/zixun/info-eye.png" alt="">
						    			</div>
						    		</div>-->
					    		</div>
							</div>
