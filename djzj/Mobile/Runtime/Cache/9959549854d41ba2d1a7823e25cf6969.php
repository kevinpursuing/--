...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Public/Mobile/css/lolrace.css">
</head>
...
// });
    ...
    <div class="sub-h sub-h1" style="display: none;">
        <?php if(is_array($bs_xiangmu)): $i = 0; $__LIST__ = $bs_xiangmu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/lolrace',array(mid=>$l[id],xid=>$_GET[xid]));?>"><div class="lol-event"><?php echo ($l["name"]); ?></div></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <div class="sub-h sub-h2" style="display: none;">
        <?php if(is_array($bs_xuexiao)): $i = 0; $__LIST__ = $bs_xuexiao;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/lolrace',array(xid=>$l[id],mid=>$_GET[mid]));?>"><div class="lol-event"><?php echo ($l["name"]); ?></div></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <script type="text/javascript">
    var cl = 0;
    ...
    <div style="margin-top:130px;">
        <?php if(is_array($days)): $i = 0; $__LIST__ = $days;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i; if(!empty($d["jilu"])): ?><div class="race-s-header">
                    <span><?php echo ($d["day"]); ?>周<?php echo ($d["xingqi"]); ?></span>
                    <span><?php echo ($bs_xiangmuname["name"]); ?>/<?php echo ($bs_xuexiaoname["name"]); ?></span>
                    <span><?php echo ($d["jilu"]["0"]["didian"]); ?></span>
                </div>
                <div class="team-list">
                    <?php if(is_array($d["jilu"])): $i = 0; $__LIST__ = $d["jilu"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$j): $mod = ($i % 2 );++$i;?><div class="t-bet1">
                            <div class="t-logo1">
                                <?php if(($j["team1"]) == "0"): ?><img src="<?php echo ($j["user1info"]["solologo"]); ?>" alt="<?php echo ($j["user1info"]["soloname"]); ?>">
                                    <div class="t-tname">
                            ...
                            <div class="t-logomid">
                                <div class="t-logomid_li2">
                                    <?php if(($j["jieguo"]) == ""): ?><span class="t-logomid_li2_bf"><?php echo ($j["shifen"]); ?></span>
                                        <?php else: ?>
                                        <span class="t-logomid_li2_bf"><?php echo ($j["jieguo"]); ?></span><?php endif; ?>
                            ...
                            <div class="t-logo2">
                                <?php if(($j["team2"]) == "0"): ?><img src="<?php echo ($j["user2info"]["solologo"]); ?>" alt="<?php echo ($j["user2info"]["soloname"]); ?>">
                                    <div class="t-tname">
