...
<div class="top">
	<?php if(($_SESSION["gametypeid"]) == "1"): ?><img src="__PUBLIC__/images/user-banner.png" /><?php endif; ?>
	<?php if(($_SESSION["gametypeid"]) == "2"): ?><img src="__PUBLIC__/images/user-banner2.png" /><?php endif; ?>
	<div class="home-user about-user">
		...
		<span>
			<h3><?php echo ($name); ?></h3>
			<p>战友奖励：<font class="color-about"><?php echo ($recomgolds); ?></font>金币</p>
		</span>
...
<div class="wrapbody">
	<div class="linkwrap">
        <a href="<?php echo U('Index/myqr');?>">我的二维码（进入>>截图发给小伙伴）</a>
        <a href="<?php echo U('Index/recoms');?>">我的战友</a>
        <a href="<?php echo U('Index/art',array(aid=>5));?>">战友招募说明</a>
