...
<div class="wrap margin-top58 login">
    <h3>选择游戏</h3> 
    <div class="row choice">
      <div class="col-md-6 choice-l">
          <a <?php if(($_SESSION["gametypeid"]) == "2"): ?>class="active"<?php endif; ?> href="javascript:;" data-gametypeid="2"><!--选中active-->
             <span><img src="__PUBLIC__/images/logo_dota.png"></span> 
             Dota2
          </a>
      </div>
      <div class="col-md-6 choice-l" data-gametype="1">
         <a <?php if(($_SESSION["gametypeid"]) == "1"): ?>class="active"<?php endif; ?> href="javascript:;" data-gametypeid="1">
             <span><img src="__PUBLIC__/images/hero_logo.png"></span> 
             英雄联盟
          </a>
      </div>
    </div>
	<a class="dota-ch gametypeid1" href="<?php echo U('Index/index',array(gtypeid=>1));?>" <?php if(($_SESSION["gametypeid"]) == "2"): ?>style="display:none;"<?php endif; ?> >进入英雄联盟</a>
	<a class="dota-ch gametypeid2" href="<?php echo U('Index/index',array(gtypeid=>2));?>" <?php if(($_SESSION["gametypeid"]) == "1"): ?>style="display:none;"<?php endif; ?> <?php if(($_SESSION["gametypeid"]) == ""): ?>style="display:none;"<?php endif; ?> >进入Dota2</a>
	
<script type="text/javascript">
$(".choice-l a").click(function(){
	$(".choice-l a").removeClass();
	$(this).addClass("active");
	var gametypeid=$(this).attr("data-gametypeid");
	$("a.dota-ch").hide();
	$("a.gametypeid"+gametypeid).show();
});
</script>
</div>
<style type="text/css">
body{background:url(__PUBLIC__/images/bg01.jpg);}
</style>
<div class="footerbox">
    <ul>
