...
<div class="top">
	<?php if(($_SESSION["gametypeid"]) == "1"): ?><img src="__PUBLIC__/images/user-banner.png"  style="width:100%;min-height:24rem;" /><?php endif; ?>
	<?php if(($_SESSION["gametypeid"]) == "2"): ?><img src="__PUBLIC__/images/user-banner2.png" style="width:100%;min-height:24rem;" /><?php endif; ?>
	<div class="home-user about-user">
		<div class="user-about">
			<?php if(empty($header)){ ?>
				<img src="__PUBLIC__/images/user-inco.png">
			<?php }else{ ?>
		...
		<span>
			<h3><?php echo ($name); ?></h3>
			<p>金币余额：<font class="color-about"><?php echo ($golds); ?></font></p>
			<p>竞猜高手：已赚取<font class="color-about"><?php echo ($yiz_golds); ?></font>金币</p>
			<a class="certification" href="<?php echo U('Index/topay');?>">
				<?php if(empty($sf_sc)): ?>首充豪礼
					<i class="tx_icon_red"></i>
				<?php else: ?>
					金币充值<?php endif; ?>
			</a>
		</span>
...
<div class="wrapbody">
  <div class="linkwrap">
        <a href="<?php echo U('Index/mygolds');?>"><img src="__PUBLIC__/images/about-ico01.png" />金币明细</a>
        <a href="<?php echo U('Index/tobuy');?>"><img src="__PUBLIC__/images/about-ico02.png" />金币兑换</a>
        <a href="<?php echo U('Index/myquiz');?>"><img src="__PUBLIC__/images/about-ico03.png" />竞猜历史消息<!--<span class="tag bg-red fr">3</span>--></a>
        <a href="<?php echo U('Index/recom');?>"><img src="__PUBLIC__/images/about-ico04.png" />战友招募</a>
    </div>
    <div class="linkwrap">
        <a href="<?php echo U('Index/art',array(fid=>2));?>"><img src="__PUBLIC__/images/about-ico05.png" />关于</a>
        <a href="<?php echo U('Index/chtype');?>"><img src="__PUBLIC__/images/about-ico06.png" />切换游戏</a>
    </div>
</div>
